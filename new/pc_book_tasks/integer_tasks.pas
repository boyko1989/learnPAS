...
{1} writeln('С начала суток прошло ', count_hours, ' полных часов');
{2} writeln('С начала часа прошло ', mins_fr_hour, ' полных минут');
{3} writeln('С начала минуты прошло ', count_secs, ' секунд');
end.
